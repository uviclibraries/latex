...
3.  **Using Chapter 4 (pg. 17-18) [https://goo.gl/MFp45A](https://goo.gl/MFp45A){:target="_blank"} for reference, write code below your most recent `\newpage` line to produce the tables below:**
...
2.  Immediately below the last `\end{tabular}` type another `\newpage`
3.  **Insert and refer figures**<br>
...
3.  Immediately below the line referring the figure, type another `\newpage`
4.  **Create a three-line table (research paper style)**<br>
...
4.  **Note:** Please ensure that the following codes are inserted into your main body, which means that it should be anywhere below the \begin{document} but above the \end{document}.
5.  **Refer the table**<br>
